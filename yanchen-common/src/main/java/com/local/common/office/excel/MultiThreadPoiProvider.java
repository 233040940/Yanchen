...
@ThreadSafe
public class MultiThreadPoiProvider<T  extends ExcelTemplate> extends PoiExcelProvider<T> {

    private final WorkerSource workerSource;

    private MultiThreadPoiProvider(WorkerSource workerSource) {
        this.workerSource = workerSource;
    }

    public static <T  extends ExcelTemplate> MultiThreadPoiProvider of(WorkerSource workerSource){
        return new MultiThreadPoiProvider<T>(workerSource);
    }
    @Override
    ...
    @Override
    public Collection<T> read(String path, String excelName, String sheetName, Class<T> excelTemplate, ExcelProvider.ExcelSuffix excelSuffix) {
    ...
    public boolean write(String path, String excelName, String sheetName, Class<T> excelTemplate, ExcelSuffix excelSuffix, Collection<T> excelEntities) {
        ...
        startCreateExcelTemplateTitle(sheet, findExcelTemplateTitle(fields, excelSuffix), excelSuffix);
        try {

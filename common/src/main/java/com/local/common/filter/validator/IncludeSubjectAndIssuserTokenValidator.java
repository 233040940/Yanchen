 ...
 */
public class IncludeSubjectAndIssuserTokenValidator extends AbstractTokenValidator {

    private String subject;   //接收对象

    private String issuer;    //签发对象

    public IncludeSubjectAndIssuserTokenValidator(String subject,String issuer){
